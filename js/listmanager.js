...
if (JSON.parse(decodeURIComponent(getCookie("list"))) != null) {
...
function setshoppinglist() {
	...
	xmlhttp.open("GET","http://127.0.0.1:8081/setshopping.php",true);
...
function createListElement() {
    ...
    input.value = "";
    document.cookie = "list"+"="+shoppinglist+"; path=/";
    setshoppinglist();
}
...
clearit.addEventListener("click", clearcookies);
